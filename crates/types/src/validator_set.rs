...
use crate::{address::Address, context::LoadContext, signing::PublicKey};
...
impl Validator {
    ...
    pub fn new(public_key: PublicKey, voting_power: VotingPower) -> Self {
        Self { address: Address::from_public_key(&public_key), public_key, voting_power }
    }
}
...
impl malachitebft_core_types::Validator<LoadContext> for Validator {
...
impl malachitebft_core_types::ValidatorSet<LoadContext> for ValidatorSet {
    fn count(&self) -> usize {
        self.validators.len()
    }
